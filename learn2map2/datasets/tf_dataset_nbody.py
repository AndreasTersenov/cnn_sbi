...
_DESCRIPTION = """
N-body cosmological simulations for parameter inference.
"""
...
class NbodyCosmogridDataset(tfds.core.GeneratorBasedBuilder):
    ...
    def _info(self) -> tfds.core.DatasetInfo:
        ...
        return tfds.core.DatasetInfo(
            ...
            features=tfds.features.FeaturesDict(
                {
                    # Only include map_nbody feature
        ...
        for i in range(start, end):
            ...
            for j in range(7):
                ...
                for k in range(nb_of_projected_map):
                    ...
                    # Yield only map_nbody and theta
                    yield f"{i}-{j}-{k}", {
