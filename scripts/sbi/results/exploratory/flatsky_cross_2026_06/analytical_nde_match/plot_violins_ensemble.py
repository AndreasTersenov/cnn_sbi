...
+ a standalone FoM3 violin. Output: violins_ensemble_3arm.{png,pdf}, violin_fom3_ensemble_3arm.{png,pdf}
"""
import matplotlib
matplotlib.use("Agg")
...
ARMS = [
    ...
    ("joint l1 → RealNVP", "joint l1 (ens)", f"{HERE}/jointl1_nobnt_ensemble/per_patch_metrics.npz", "#2ca02c"),
...
for ext in ("png", "pdf"):
    fig.savefig(HERE / f"violins_ensemble_3arm.{ext}", dpi=150, bbox_inches="tight")
print("wrote violins_ensemble_3arm.png")
plt.close(fig)
...
figf.tight_layout()
for ext in ("png", "pdf"):
    figf.savefig(HERE / f"violin_fom3_ensemble_3arm.{ext}", dpi=150, bbox_inches="tight")
print("wrote violin_fom3_ensemble_3arm.png")
